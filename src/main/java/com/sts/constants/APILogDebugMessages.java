 ...
 */
public enum APILogDebugMessages {

	
	REQUEST_OBJECT("API: Request object for %s: %s"),
    RESPONSE_OBJECT("API: Response object for %s: %s"),
    BULK_REQUEST_OBJECT("API: Bulk request for %s with size %s: %s");

	private final String message;

	APILogDebugMessages(String message) {
