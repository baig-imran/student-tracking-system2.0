...
public enum ValidatorRulesEnum {
	...
	DUPLICAE_STUDENT_ID_VALIDATOR("DUPLICAE_STUDENT_ID_VALIDATOR"),
	DUPLICAE_FACULTY_ID_VALIDATOR("DUPLICAE_FACULTY_ID_VALIDATOR"),
	DUPLICAE_DEPARTMENT_ID_VALIDATOR("DUPLICAE_DEPARTMENT_ID_VALIDATOR")
